...
def main():
    repeat = "y"
    file = "Billing.txt"
    BillingModule.resetBillingFile(file)
    ...
    while repeat == "y":
        ...
        BillingModule.writeBillingRecord(file, employee, hourlyRate, week1, week2, week3, week4)
        ...
        if totalHours > REGULAR_HOURS:
            ...
            regular_hours = 'Regular Hours: ' + format(REGULAR_HOURS, '.2f') + ' @ $' + format(hourlyRate, '.2f') + '\t= $' + format(regularHourRate, ',.2f')
